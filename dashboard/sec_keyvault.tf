...
module "key_vault" {
  ...
  providers = { azurerm = azurerm.dashboard }

  name                           = "acme-health-dashbrd-key-vault"
  ...
  create_cmk                     = true
  cmk_key_name                   = "acme-health-dashboard-cmk-key"
  cmk_key_size                   = 2048
  create_des                     = true
  des_name                       = "acme-health-dashboard-hipaa-disk-encryption-set"
