...
module "key_vault" {
  ...
  providers = { azurerm = azurerm.firewall }

  name                           = "acme-health-fw-keyvault"
  ...
  network_acls_ip_rules          = var.admin_ips
  create_cmk                     = true
  cmk_key_name                   = "acme-health-firewall-cmk-key"
  cmk_key_size                   = 2048
  create_des                     = true
  des_name                       = "acme-health-firewall-hipaa-disk-encryption-set"
